...
def user_sub_post_save(sender, instance, *args, **kwargs):
    from .tasks import user_sub_post_save_task

    task_name = get_task_name(user_sub_post_save_task)
...
def user_sub_post_delete(sender, instance, *args, **kwargs):
    from .tasks import user_sub_post_delete_task

    task_name = get_task_name(user_sub_post_delete_task)
    send_task_to_sqs(task_name=task_name, instance=instance)
